...
async def submit_single_analysis(
    ...
    try:
        ...
        # 使用 asyncio.create_task 真正后台执行，避免 BackgroundTasks 拖慢响应返回
        ...
        if result:
            ...
            if task_result:
                ...
                status_data = {
                    ...
                    "status": status,
                    "progress": progress,
                    "message": task_result.get("message") or f"任务{status}中...",
