...
硅基流动（SiliconFlow）是一个高性价比的 AI 推理服务平台，提供多种开源大模型的 API 访问。本指南将帮助您在 TradingAgents-CNFI 中配置和使用硅基流动。
...
恭喜！您已经成功配置了硅基流动。现在可以在 TradingAgents-CNFI 中使用硅基流动的模型进行 AI 分析了。
