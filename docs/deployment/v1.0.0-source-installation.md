...
```bash
git clone https://github.com/hsliuping/TradingAgents-CNFI.git
...
- **GitHub Issues**: https://github.com/hsliuping/TradingAgents-CNFI/issues
- **文档**: 项目 `docs/` 目录下的详细文档
- **微信公众号**: 搜索"TradingAgents-CNFI"关注获取最新资讯
- **邮件**: hsliup@163.com
