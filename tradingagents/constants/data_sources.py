...
class DataSourceCode(str, Enum):
    ...
    GILDATA = "gildata"      # Gildata - 恒生聚源专业金融数据
...
DATA_SOURCE_REGISTRY: Dict[str, DataSourceInfo] = {
    ...
    # Gildata (恒生聚源)
    DataSourceCode.GILDATA: DataSourceInfo(
        code=DataSourceCode.GILDATA,
        name="Gildata",
        display_name="恒生聚源 Gildata",
        provider="恒生电子",
        description="恒生聚源专业金融数据API，提供预计算的技术指标、估值、资金流向和风险指标",
        supported_markets=["a_shares"],
        requires_api_key=True,
        is_free=False,
        official_website="https://www.gildata.com",
        features=["预计算技术指标", "估值数据", "资金流向", "风险指标", "KDJ指标", "量均线"],
    ),
